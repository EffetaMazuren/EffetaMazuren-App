                ...
                <div key={cam.id} style={{
                  ...
                  {infoAbierta && (
                    <div style={{ borderTop: `1px solid ${cam.es_sorpresa ? '#fca5a5' : '#f0f0f3'}`, padding: '12px 14px', background: cam.es_sorpresa ? '#fff0f0' : '#f9f9fc', display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      {/* Contacto emergencia sorpresa — dentro del mismo panel */}
                      {cam.es_sorpresa && (
                        <div style={{ marginTop: 4 }}>
                          <p style={{ fontSize: 10, fontWeight: 700, color: '#dc2626', margin: '0 0 6px', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                            Contacto para coordinar llegada
                          </p>
                          {cam.contacto_emergencia ? (
                            <div style={{ background: 'white', borderRadius: 10, padding: '10px 12px', border: '1px solid #fca5a5' }}>
                              ...
                              {cam.contacto_emergencia.celular && (
                                <button
                                  ...
                                  style={{ display: 'flex', alignItems: 'center', gap: 6, background: '#25d366', color: 'white', border: 'none', borderRadius: 8, padding: '7px 12px', fontSize: 13, fontWeight: 600, cursor: 'pointer', marginTop: 4 }}
                                >
