        ...
        <div>
          ...
          {loadingCuartos ? (
            ...
            <>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
                {[
                  { label: 'Total asig.', val: totalAsig, color: '#0f1787' },
                  { label: 'Servidores', val: totalSrv, color: '#1e40af' },
                  { label: 'Caminantes', val: totalCam, color: '#16a34a' },
                  { label: 'Sin cuarto', val: personasSinCuarto.length, color: '#dc2626' },
                ].map(s => (
              ...
              <div style={{ display: 'flex', gap: 6, marginBottom: 16, flexWrap: 'wrap' }}>
                ...
                {[
                  { label: 'Todos', val: 'todos' as const },
                  { label: 'Servidores', val: 'servidor' as const },
                  { label: 'Caminantes', val: 'caminante' as const },
                  { label: 'Libre', val: 'libre' as const },
                ].map(f => (
